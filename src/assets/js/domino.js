...
!(function () {
  ...
  (function () {
    ...
    const storiesPopupWidthRatio = Math.ceil((actualImageXCanShow / storiesRatio[0]) * storiesRatio[1]);
  ...
  (function () {
    ...
    for (let index = 0; index < modalProducts.length; index++) {
      ...
      const moreLessTextElement = modal.querySelector(".modal-information .more-less");
      ...
      function handlerReadMoreDescription(toggle) {
        ...
        if (isReadMoreExpand && !toggle) {
          toggleButton = modal.querySelector(".modal-information .more-less-less");
        } else if (!isReadMoreExpand && toggle) {
          toggleButton = modal.querySelector(".modal-information .more-less-more");
        }
        ...
        setTimeout(() => {
          !!$.fn.readmore &&
            $(selector).readmore({
              ...
              collapsedHeight: 36,
              moreLink: '<a class="more-less-more nomal text-armchair" href="#">Xem thêm</a>',
...
$(document).ready(function () {
  ...
  if ($(".side-bar").length > 0) {
    ...
    $(".side-bar .collapse-bar").on("click", function () {
  ...
  if ($(".payment-wrap").length > 0) {
    let inputElement = $(this, "form").find("input");
    $(this, "form")
      .find("button")
      .on("click", function () {
        if (inputElement.val() === "") {
          ...
          $(".payment-wrap form").css("display", "none");
          $(".payment-wrap .list-discount").css("display", "flex");
        }
      });
    $(this)
      .find(".voucher-mobile")
      .on("click", function () {
        ...
        $(".payment-wrap form").css("display", "flex");
      });
  }
  window.onscroll = function () {
    ...
    let positionBack = $("#backToTop")[0].getBoundingClientRect();
    let positionFooter = $(".footer")[0].getBoundingClientRect();
    if (positionBack.top + 5 > positionFooter.top) {
